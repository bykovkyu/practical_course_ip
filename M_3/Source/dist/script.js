...
window.addEventListener('DOMContentLoaded', () => {
  const mainPageSlider = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_0__["default"]({
    btns: '.next',
    container: '.page'
  });
  ...
  constructor(_ref) {
    let {
      ...
      next
        ...
        values = _objectWithoutProperties(_ref, ["prev", "next"]);
...
class Slider {
  constructor({
    ...
    this.slideIndex = 1; // console.log('Slider', this.page, this.slides, this.btns, this.slideIndex);
  }
