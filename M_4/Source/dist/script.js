...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.closest = function (selector) {
  let counter = 0;
  for (let i = 0; i < this.length; i++) {
    this[i] = this[i].closest(selector) !== null ? this[i].closest(selector) : this[i];
    counter++;
  }
  const objLength = Object.keys(this).length;
...
(0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])().get('https://jsonplaceholder.typicode.com/todos/1', 'json').then(console.log);
})();
